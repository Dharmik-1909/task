...
// console.log(country);
// {only remove commemnt to see output of constant otherwise it will show error}
...
console.table(['dharmik','alpesh','Manan','Nityan','denish']);

// TASK 16

// console.clear(); 
// {only remove commemnt to see output of console.clear otherwise all the above console screen will be cleared}
